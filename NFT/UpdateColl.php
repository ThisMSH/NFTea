        ...
        <div class="Account">
            <div class="formBx">
                <div class="form signupForm">
                    <form action="updateCollCntr.php?ID=<?php echo $x?>" method="post">
                        <h3>Update your Collection</h3>
                        <div class="form-floating mb-5">
                            <input name="nameUpdatedcoll" type="text" class="form-control" id="floatingInputColUpdate" placeholder="Collection Update" required>
                            <label for="floatingInputColUpdate">Enter the new name of your Collection</label>
                        </div>
