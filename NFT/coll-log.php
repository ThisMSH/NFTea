                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    ...
                                    <div class="btn-container">
                                        <a href="UpdateNFT.php" type="button" class="btn btn-primary add-delete-btn">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <a href="deleteNFT.php?ID=<?php echo $row2['Nid']?>" type="button" class="btn btn-primary add-delete-btn">
