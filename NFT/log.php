        ...
        <div class="formBx">
            <div class="form signinForm">
                <form action="signIN.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" name="email" class="form-control" id="floatingInputSI" placeholder="name@example.com" required>
                        <label for="floatingInput">E-mail</label>
                    </div>
                    <div class="form-floating">
                        <input type="password" name="password" class="form-control" id="floatingPasswordSI" placeholder="Password" required>
            ...
            <div class="form signupForm">
                <form action="signUP.php" method="post">
                    <h3>Sign Up</h3>
                    <div class="form-floating">
                        <input type="text" name="userName" class="form-control" id="floatingInputSI" placeholder="Username" required>
