                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav ms-auto gap-2">
                            <li class="nav-item">
                                <a href="index.html" class="nav-link nav-link-mod active">
                        ...
                        <button class="btn rounded-pill px-3 py-2 ms-3 btn-login"><span>Login</span></button>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="col top-page-welcome">
                    ...
                    <div class="home-welcome-btn">
                        <div class="btn-home-top">
                            <a href="supp/destroyed.php">Collections</a>
                        </div>
                        <div class="btn-home-top">
                            <a href="creerCollection.php">Statistics</a>
                        </div>
                        <div class="btn-home-top">
                            <a href="uploadNft.php">Statistics</a>
                        </div>
                    </div>
                </div>
