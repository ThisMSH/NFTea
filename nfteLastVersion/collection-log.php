...
$pid=$_SESSION['Pid'];
$myNft = mysqli_query($conn,"select * from nft where Pid=$pid");
$myCol = mysqli_query($conn,"select * from collection where Pid=$pid");
$Nft = mysqli_query($conn,"select * from nft ");
$Col = mysqli_query($conn,"select * from collection");
...
//delete nft
if(isset($_GET['delIDnft']))
{
    // echo "hello2";
    $ridcollN=$_GET['delIDnft'];
    $sqlcollN=mysqli_query($conn,"delete from nft where Nid=$ridcollN");
...
<body>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav ms-auto gap-2">
                            ...
                            <li class="nav-item">
                                <a href="" class="nav-link nav-link-mod">
    ...
    <main>
        ...
        <div class="container top-collection">
                    ...
                    <form action="addNft.php" method="post" enctype="multipart/form-data" class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-3 input-group-sm">
                                ...
                                <input type="number" class="form-control" class="price" name="prix">
                            </div>
                            <div class="input-group mb-3 input-group-sm">
                                <span class="input-group-text" >Picture</span>
                                <input type="file" class="form-control" class="image" name="my_image">
                            </div>
                            <div class="input-group mb-3 input-group-sm">
                                <span class="input-group-text">description</span>
                                <!-- <textarea name="descriptin" id="" cols="30" rows="10"></textarea> -->
                                <input type="text" class="form-control" class="price" name="descriptin">
                            </div>
                        </div>
            ...
            <!-- The Modal -->
            <div class="modal" id="addCollection">
                <div class="modal-dialog">
                    <form action="creerCollection.php" class="modal-content" method="post">
                        <!-- Modal Header -->
                        <div class="modal-header">
                        ...
                        <div>
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link discover-nav active" id="collections-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">ALL Collections</button>
                                    <button class="nav-link discover-nav" id="nfts-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">ALL NFTs</button>
                                    <button class="nav-link discover-nav" id="my-collections-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">My Collections</button>
                                    <button class="nav-link discover-nav" id="my-nfts-tab" data-bs-toggle="tab" data-bs-target="#nav-contact1" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">My NFTs</button>
                                </div>
                            </nav>
                            <br>
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="collections-tab" tabindex="0">
                                    <div class="container">
                                        <div class="row">
                                        <?php while($row1 = mysqli_fetch_assoc($Col)){ 
                                                    $p = $row1['Pid'];
                                                    $name = mysqli_query($conn,"select username from users where Pid = $p");
                                                    ?>
                                            <div class="col-12 col-md-4 mb-4">
                                                ...
                                                <div class="card p-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><i class="fa-solid fa-palette"></i> Made by: <span><?php $p?></span></p>
                                ...
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nfts-tab" tabindex="0">
                                    <div class="container">
                                        <div class="row">
                                        <?php while($row2 = mysqli_fetch_assoc($Nft)){
                                                $p = $row2['Pid'];
                                                $name = mysqli_query($conn,"select username from users where Pid = $p");
                                                ?>
                                            <div class="col-12 col-md-4 mb-4">
                                                ...
                                                <div class="card p-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><i class="fa-solid fa-user-large"></i> Owned by: <span><?php $name?></span></p>
                                ...
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="my-collections-tab" tabindex="0">
                                    <div class="container">
                                        <div class="row">
                                        <?php while($row3 = mysqli_fetch_assoc($myCol)){?>
                                            <div class="col-12 col-md-4 mb-4">
                                            
                                                <div class="card p-3">
                                                    <img src="img/1.jpg" class="card-img-top" alt="Collection image">
                                                    <div class="card-body">
                                                        <h5 class="card-title"><i class="fa-solid fa-signature"></i> Collection title<?php echo $row3['name']?> <i class="fa-solid fa-paintbrush"></i></h5>
                                                        <p class="card-text"><i class="fa-solid fa-palette"></i> Made by: <span><?php echo $_SESSION['username'] ?></span></p>
                                                        <p class="card-ID"><i class="fa-solid fa-hashtag"></i> ID: <span>#<?php echo $row3['Cid']?></span></p>
                                                    </div>
                                                    <div class="btn-container">
                                                    
                                                            <button  type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#updateCollection?CidColl=<?php echo $row3['Cid'];?>">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>

                                                        <a href="collection-log.php?delID=<?php echo $row3['Cid']; $tmpC=$row3['Cid']?>" class="delete" title="Delete" data-toggle="tooltip" >
                                                            <button type="submit" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="" name="delete">
                                    ...
                                    <!-- The Modal -->
                                    <div class="modal" id="updateCollection">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Modify your Collection</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <!-- Modal body -->
                                                <div class="modal-body">
                                ...
                                <?php while($row4 = mysqli_fetch_assoc($myNft)){?>
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-4 mb-4">
                                                ...
                                                <div class="card p-3">
                                                    <img src="<?php echo $row4['image']?>" class="card-img-top" alt="Collection image">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><i class="fa-solid fa-user-large"></i> Owned by: <span><?php echo $_SESSION['username'] ?></span></p>
                                                        <p class="card-collection"><i class="fa-solid fa-folder"></i> Collection: <span>#<?php echo $row4['Cid'] ?></span></p>
                                                        <p class="card-ID"><i class="fa-solid fa-hashtag"></i> ID: <span>#<?php echo $row4['Nid'] ?></span></p>
                                                        <p class="card-price"><i class="fa-solid fa-coins"></i> Price:<br><br> <span><?php echo $row4['prix'] ?></span> ETH</p>
                                                        <div class="btn-container">

                                                            <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#updateNFT" <?php $tmpN=$row4['Nid']?>>
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>
                                                            <a href="collection-log.php?delIDnft=<?php echo $row4['Nid'];?>" class="delete" title="Delete" data-toggle="tooltip" >
                                                            <button type="submit" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="" name="deleteNft">
                                                                <i class="fa-solid fa-trash"></i>
                                                                
                                                            </button>
                                                            </a>
                                                            <!-- <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="">
                                                                <i class="fa-solid fa-trash"></i>
                                                            </button> -->
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- The Modal -->
                                    <div class="modal" id="updateNFT">
                                        <div class="modal-dialog">
                                            <form action="update.php" method="post" class="modal-content" >
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Modify your NFT</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <!-- Modal body -->
                                                <div class="modal-body">
                                                    <div class="input-group mb-3 input-group-sm">
                                                        <span class="input-group-text">Name</span>
                                                        <input type="text" class="form-control" name="nameUpdate">
                                                    </div>
                                                    <div class="input-group mb-3 input-group-sm">
                                                        <span class="input-group-text">Price</span>
                                                        <input type="number" class="form-control" name="priceUpdate">
                                                    </div>
                                                </div>
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <a href="update.php?Update1=<?php echo $tmpN; $_SESSION['IDn'] = $tmpN?>" class="update" title="update" data-toggle="tooltip">
                                                    <button type="submit" name="submitUpdate" class="btn btn-primary" data-bs-dismiss="modal">Update</button>
                                                    <?php echo $tmpN?>
                                                </a>
                                                </div>
                                        </form>
