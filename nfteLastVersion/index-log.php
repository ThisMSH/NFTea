...
// $cheapestNft = mysqli_query($conn, "SELECT MIN(prix) FROM nft ");
$row = mysqli_fetch_assoc($order);

// $row = mysqli_query($conn, "SELECT MIN(prix) FROM nft ");
//$row = mysqli_fetch_assoc($cheapestNft);
...
<body>
    ...
    <main>
        ...
        <div class="container collection-home">
            <div class="row">
                <?php while($rowNft = mysqli_fetch_assoc($res2)){?>
                <div class="col">
                    <div class="collection-container">
                        <div class="collection-1"></div>
                        <div class="collection-1-img">
                            <img src="<?php echo $rowNft['image']?>" alt="member image">
                        </div>
                        <div class="collection-1-name">
                            <h3><?php echo $rowNft['name']?></h3>
                        </div>
                    </div>
                </div>
                <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="team-member">
                        <div class="member"></div>
                        <div class="member-img">
                            <img src="img/9irsh.png" alt="member image">
                        </div>
                        <div class="member-info">
                            <div class="member-details">
