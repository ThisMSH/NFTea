                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav ms-auto gap-2">
                            ...
                            <li class="nav-item">
                                <a href="stats - log.php" class="nav-link nav-link-mod active">
        ...
        <div class="ab2">
            ...
            <div class="ab2-sub1">
                <div class="ab2-sub1-nft">
                    ...
                    <div class="card p-3">
                        <img src="<?php echo $ch['image']?>" class="card-img-top" alt="Collection image">
                        <div class="card-body">
                            <h5 class="card-title">
                ...
                <div class="ab2-sub1-nft">
                    ...
                    <div class="card p-3">
                        <img src="<?php echo $chE['image']?>" class="card-img-top" alt="Collection image">
                        <div class="card-body">
                            <h5 class="card-title">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-signature" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
