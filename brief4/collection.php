                    ...
                    <form class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput01" placeholder="NFT name" required>
                                <label for="floatingInput01">The name of your NFT</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput02" placeholder="Collection name" required>
                                <label for="floatingInput02">The name of its Collection</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInput03" placeholder="NFT price" required>
                                            ...
                                            <div class="col-12 col-md-4 mb-4">
                                                <div class="card p-3">
                                                    ...
                                                    <div class="btn-container">
                                                        <button type="button" class="btn btn-primary add-delete-btn special-btn" data-bs-toggle="modal" data-bs-target="#moreCollection">
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6 mb-4">
                                                            <div class="card p-3">
                                                                <img src="img/nft2.jpg" class="card-img-top" alt="Collection image">
                                                                <div class="card-body">
                                                                    <h5 class="card-title">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-4 mb-4">
                                                <div class="card p-3">
                                                    ...
                                                    <div class="btn-container">
                                                        <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#updateCollection">
                                            ...
                                            <div class="col-12 col-md-4 mb-4">
                                                <div class="card p-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-price"><i class="fa-solid fa-coins"></i> Price:<br><br> <span>0.234</span> ETH</p>
                                                        <div class="btn-container">
                                                            <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#updateNFT">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>
