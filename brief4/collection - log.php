                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="user-container">
                            <div class="user-info">
                                ...
                                <a href="connectData/destroyed.php">
                                    <button class="btn rounded-pill px-3 py-2 btn-login btn-logout"><span>Logout</span></button>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container top-collection">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active" data-bs-interval="3000">
                            <img src="img/nft4.jpg" class="d-block" alt="NFT Image">
                          </div>
                          <div class="carousel-item" data-bs-interval="3000">
                            <img src="img/nft3.png" class="d-block" alt="NFT Image">
                          </div>
                          <div class="carousel-item" data-bs-interval="3000">
                            <img src="img/nft4.jpg" class="d-block" alt="NFT Image">
                          </div>
            ...
            <div class="modal fade" id="addNFT">
                <div class="modal-dialog">
                    <form class="modal-content" action="addNft.php" method="post" enctype="multipart/form-data">
                        <!-- Modal Header -->
                        ...
                        <div class="modal-body">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput01" placeholder="NFT name" required name="nom">
                                <label for="floatingInput01">The name of your NFT</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput02" placeholder="Collection name" required name="collection">
                                <label for="floatingInput02">The name of its Collection</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInput03" placeholder="NFT price" required name="prix">
                                <label for="floatingInput03">The price of your NFT</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput02" placeholder="description " required name="description">
                                <label for="floatingInput02">describtion </label>
                            </div>
                            <div class="">
                                <label for="formFile" class="form-label">Upload your NFT</label>
                                <input class="form-control" type="file" id="formFile" required name="my_image">
                            </div>
                        </div>
                        <!-- Modal footer -->
            ...
            <div class="modal fade" id="addCollection">
                <div class="modal-dialog">
                    <form class="modal-content" action="creerCollection.php" method="post">
                        <!-- Modal Header -->
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="floatingInput01" placeholder="NFT name" required name="Cname">
                                <label for="floatingInput01">The name of your Collection</label>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="modal-footer">
                            <input type="submit" class="btn btn-primary" value="Add" name="submit"></input>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div>
                            <nav>
                                <div class="nav nav-tabs collection-nav" id="nav-tab" role="tablist">
                                    ...
                                    <button class="nav-link" id="my-nfts-tab" data-bs-toggle="tab" data-bs-target="#nav-contact1" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">My NFTs</button>
                                </div>
                            </nav>
                            <br>
                            <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <?php 
                                                ...
                                                while($row1 = mysqli_fetch_assoc($Coll) ) { 
                                                    ...
                                                    <div class="col-12 col-md-4 mb-4">
                                                        <div class="card p-3">
                                                            <img src="img/collection.jpg" class="card-img-top" alt="Collection image">
                                                            <div class="card-body">
                                                            ...
                                                            <div class="btn-container">
                                                                <button type="button" class="btn btn-primary add-delete-btn special-btn" data-bs-toggle="modal" data-bs-target="#moreCollection" <?php $idC = $row1['Cid']?>>
                                ...
                                <!-- The modal for NFTs inside a collection -->
                                <div class="modal fade" id="moreCollection">
                                    <div class="modal-dialog modal-dialog-scrollable modal-xl modal-fullscreen-sm-down">
                                        <div class="modal-content">
                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                                <h4 class="modal-title"><i class="fa-solid fa-signature"></i> Collection name <i class="fa-solid fa-paintbrush"></i></h4>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                            </div>
                                            <!-- Modal body -->
                                            <div class="modal-body">
                                                <div class="container">
                                                    <div class="row">
                                                        <!-- The start of NFT column -->
                                                        <?php
                                                        $Nft = mysqli_query($conn,"select * from nft where Cid = $idC ");
                                ...
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="my-collections-tab" tabindex="0">
                                            ...
                                            ?>
                                                <div class="col-12 col-md-4 mb-4">
                                                    <div class="card p-3">
                                                        ...
                                                        <div class="btn-container">
                                                            <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#updateCollection" <?php $tmpC=$row2['Cid']?>>
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>
                                                            <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#deleteNFTCollection">
                                    ...
                                    <!-- The update modal for collection -->
                                    <div class="modal fade" id="updateCollection">
                                        <div class="modal-dialog">
                                            <form class="modal-content" action="updateColl.php" method="post">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><i class="fa-solid fa-pencil"></i> Modify your Collection</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <!-- Modal body -->
                                                <div class="modal-body">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingInput01" placeholder="NFT name" name="nameUpdatedcoll" required>
                                                        <label for="floatingInput01">The new name of your Collection</label>
                                                    </div>
                                                </div>
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <input type="submit" <?php $_SESSION['ID_C'] = $tmpC?>class="btn btn-primary" value="Update" name="submit"></input>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    <!-- The delete modal for collection -->
                                    <div class="modal fade" id="deleteNFTCollection">
                                        <div class="modal-dialog">
                                            <form class="modal-content" action="deleteColl.php" method="post">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title warning-title">
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-danger" data-bs-dismiss="modal" name="submit">Remove</button>
                                ...
                                <!-- My NFTs content -->
                                <div class="tab-pane fade" id="nav-contact1" role="tabpanel" aria-labelledby="my-nfts-tab" tabindex="0">
                                    <div class="container">
                                        <div class="row">
                                        <?php
                                        $Nft1 = mysqli_query($conn,"select * from nft where Pid = $personID");
                                        while( $row3 = mysqli_fetch_assoc($Nft1) ){?>
                                            <div class="col-12 col-md-4 mb-4">
                                                <div class="card p-3">
                                                    <img src="<?php echo $row3['image']?>" class="card-img-top" alt="Collection image">
                                                    <div class="card-body">
                                                        <h5 class="card-title">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-signature" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                        ...
                                                        <p class="card-text"><i class="fa-solid fa-user-large"></i> Owned by: <span>me</span></p>
                                                        <p class="card-collection"><i class="fa-solid fa-folder"></i> Collection: <span>#<?php echo $row3['Cid']?></span></p>
                                                        <p class="card-ID"><i class="fa-solid fa-hashtag"></i> ID: <span>#<?php echo $row3['Nid']?></span></p>
                                                        <p class="card-price"><i class="fa-solid fa-coins"></i> Price:<br><br> <span><?php echo $row3['prix']?></span> ETH</p>
                                                        <div class="btn-container">
                                                            <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#updateNFT"  <?php $tmpN=$row3['Nid']?>>
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>
                                                            <button type="button" class="btn btn-primary add-delete-btn" data-bs-toggle="modal" data-bs-target="#deleteNFT">
                                                                <i class="fa-solid fa-trash"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- The update modal for NFT -->
                                    <div class="modal fade" id="updateNFT">
                                        <div class="modal-dialog">
                                            <form class="modal-content" action="updateNFT.php" method="post">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><i class="fa-solid fa-pencil"></i> Modify your NFT</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <!-- Modal body -->
                                                <div class="modal-body">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInput01" placeholder="NFT name" name="nameUpdatednft" required>
                                                        <label for="floatingInput01">The new name of your NFT</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="number" class="form-control" id="floatingInput03" placeholder="NFT price" name="priceUpdate" required>
                                                        <label for="floatingInput03">The new price of your NFT</label>
                                                    </div>
                                                    <!-- <div class="">
                                                        <label for="formFile" class="form-label">Upload a new image for your NFT</label>
                                                        <input class="form-control" type="file" id="formFile" required>
                                                    </div> -->
                                                </div>
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <input type="submit" class="btn btn-primary" value="Update" name="submit" <?php $_SESSION['ID_N'] = $tmpN?>></input>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    <!-- The delete modal for NFT -->
                                    <div class="modal fade" id="deleteNFT">
                                        <div class="modal-dialog">
                                            <form class="modal-content" action="deleteNft.php" method="post">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title warning-title">
                                                        <i class="fa-solid fa-triangle-exclamation"></i>
                                                        <p>ARE YOU SURE THAT YOU WANT TO DELETE YOUR NFT?</p>
                                                        <i class="fa-solid fa-triangle-exclamation"></i>
                                                    </h4>
                                                </div>
                                                <!-- Modal footer -->
